		...
		return(
			<div>
				<div className="profile-info">
					...
					<p className="first-nameProfile">{this.props.state.first_name}</p>
					<div className="above-input">Last Name</div>
					<p className="last-nameProfile">{this.props.state.last_name}</p>
					{/* <p className="register-username">{this.props.state.username}</p> */}
					<div className="above-input">Email</div>
					<p className="emailProfile">{this.props.state.email}</p>
				</div>
